...
def main(file_previous, file_latest):
    try: 
        ...
        sheet_pr_previous, sheet_pr_latest, sheet_vdpmv_previous, sheet_vdpmv_latest, sheet_deductions_previous, sheet_deductions_latest = load_sheets(file_previous, file_latest)
